...
3. [Backend com FastAPI](./backend/README.md) ✅
   ...
   - **Sistema de Agentes de IA** 🤖
     ...
     - Agent Orchestrator
4. [Integração com Meta API](./integracao/META_API.md) ✅
   - Autenticação
   - CRUD de campanhas
   - Insights e métricas
   - Rate limiting
5. [Frontend com Next.js](./frontend/README.md) 🚧
6. [Autenticação e Segurança](./seguranca/AUTENTICACAO.md) 🚧
7. [Deploy e Produção](./deploy/PRODUCAO.md) 🚧
